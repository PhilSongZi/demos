package com.github.philsongzi.demos.javase.juc.printer.lockAndCondition;
 ...
 * @since 2023/8/29
 */
public class LockAndConditionABC {
    ...
    public static void main(String[] args) {
        LockAndConditionABC print = new LockAndConditionABC();
        new Thread(() -> {
